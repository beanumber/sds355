...
Consider the following plot, which shows the relationship between wins and run differential for all teams since 1954. 
...
5. Using the data from the plot, how many games do you project that the Mets will win? 
\
\
\
\
