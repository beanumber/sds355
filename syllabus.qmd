...
- [Ben Baumer](https://www.smith.edu/academics/faculty/ben-baumer)  
  `r fontawesome::fa("building")` McConnell 213  
...
- *[Curveball](https://www.amazon.com/Curve-Ball-Baseball-Statistics-Chance/dp/038700193X)*. Albert and Bennett, 2003. Copernicus. 
- *[Introduction to Sports Analytics using R](https://www.prospectpressvt.com/textbooks/elmore-sports-analytics)*. Elmore and Urbaczewski, 2025. Prospect Press. 
...
- *[Bayes Rules! An Introduction to Applied Bayesian Modeling](https://www.bayesrulesbook.com/)*. Johnson, Ott, Dogucu, CRC Press, 2021. Available free online. 
...
- (15%) [Homework](hw.qmd): These assignments will include problems that allow you to work with data and analyze the results
- (20%) Midterm exam: a closed book, self-scheduled written exam
- (20%) [Colloquium presentation](colloquium.qmd): You will choose a published research paper in sports analytics, and during the second half of the semester, you and a partner will present the paper to the class. 
- (35%) [Research project](paper.qmd): a 10-page [Quarto Manuscript](https://quarto.org/docs/manuscripts/) and a 3-minute class presentation. 
...
I expect that you will [maintain your academic integrity](https://www.smith.edu/your-campus/offices-services/dean-college/academic-integrity-board/academic-integrity-board-students#waypoint-1) in this class. 
Please read [Smith's Academic Integrity Statement](https://www.smith.edu/your-campus/offices-services/dean-college/academic-integrity-board#waypoint-2).
Please pay particular attention to this sentence in the "Examples of Violations" section:
...
Please read the Smith Academic Integrity Board's statement on [Generative Artificial Intelligence & Your Academic Integrity](https://www.smith.edu/your-campus/offices-services/dean-college/academic-integrity-board/academic-integrity-board-students#waypoint-4)
...
Other learning will take place [outside of class](#expectations), wherein [you are free to use AI in whatever fashion you want](#usage) (unless otherwise noted), provided that it is in compliance with [Smith's Academic Integrity](#academic-integrity) policies. 
...
**Please read [my perspective](#my-perspective)** on learning and generative AI. 
...
- `r fontawesome::fa("slack")` [Slack](https://sds-355-01-202601.slack.com/) is the primary forum for course-related discussions of all kinds. *Please do not email me with course-related questions!* Instead, post those `#questions` on Slack. If discretion is absolutely necessary, private message me on Slack. 
...
Please see the [detailed schedule](schedule.qmd) for more specific information about readings and assignments.
