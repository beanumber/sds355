...
::: {.callout-tip}
Use the `glm()` function, or ask a `#question` on Slack about generalized linear models. 
:::

3. Use your creativity to create **one data graphic** like the ones shown in [Exploring Statcast](slides/07_statcast.qmd). Try to make this data graphic as compelling as possible. 