...
babip_plot <- ggplot(dips_pairs, aes(x = BABIP.x, y = BABIP.y)) +
  geom_point() +
  geom_label(data = filter(dips_pairs, playerID == "martipe02"), aes(label = yearID), color = "red") +
...
::: footer
<https://www.google.com/url?sa=i&url=https%3A%2F%2Flibrary.fangraphs.com%2Fpitching%2Ffip%2F&psig=AOvVaw2rfAxdxr8KsufLKJGjjjoO&ust=1758740064497000&source=images&cd=vfe&opi=89978449&ved=0CBYQjRxqFwoTCLCKnbrH748DFQAAAAAdAAAAABAE>
:::
