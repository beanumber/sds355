...
- Use your GitHub repository to write the paper. Put the paper contents into a subdirectory called `quarto-manuscript`.
- Use GitHub issues to delegate certain tasks to certain people, and to keep track of your progress.
- Use the [Manuscripts](https://quarto.org/docs/manuscripts/) feature to write the paper in Quarto.
